...
echo
echo "Below is the Token generated"
echo ${TOKEN}
...
echo
echo "Below is the list of informations which can be queried regarding the instance"
...
echo
echo "Below are the details regarding metadata of the instance in JSON format"
...
echo
echo "Below is the list of public keys"
